...
in
{
  flake.nixosConfigurations.mariogk-notebook = inputs.nixpkgs.lib.nixosSystem {
    system = "x86_64-linux";
    specialArgs = { inherit inputs; };
    modules = nixosModules ++ [
      # Host-specific configuration
      {
        networking.hostName = "mariogk-notebook";
        system.stateVersion = "24.11";
      }

      # Hardware configuration
      ../../hardware-configurations/mariogk-notebook.nix
