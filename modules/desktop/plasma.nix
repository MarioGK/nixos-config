...
{
  # NixOS module for Plasma 6 system configuration
  flake.modules.nixos.desktop-plasma = { config, lib, pkgs, ... }: {
    # KDE Plasma 6
    ...
    # Greetd with tuigreet (replaces SDDM) - use mkDefault so ISO can override
    services.greetd = {
    ...
    # Disable SDDM by default (can be overridden by ISO/other modules)
  ...
  # Home Manager module for Plasma user configuration
  flake.modules.homeManager.desktop-plasma = { config, lib, pkgs, ... }: {
